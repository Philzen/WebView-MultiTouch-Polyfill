...
/**
 * WebClient class to polyfill missing multitouches on WebViews on Android 2.2 - 2.3 devices
 * support for Android 2.1 and earlier is on the roadmap: https://github.com/Philzen/WebView-MultiTouch-Polyfill/issues/25
 *
 * This class will not interfere with your webview at all when running on android 3 (honeycomb) or higher
 * 
...
//	android.util.Log.v("console", "loadresource_" + url);
    ...
    /**
     * Returns the collected touches and clears the TouchBuffer (needed for TouchUpdater)
     *
     * @author fastrde
     * @return
     */
...
//		    android.util.Log.d("console", arg1.toString());
    ...
    /**
     * This nested class provides getter and setter for the javascript Interface to WebClient. Issue:
     * https://github.com/Philzen/WebView-MultiTouch-Polyfill/issues/1 Fell free to implement wanted Bridge
     * functionality.
     *
     * @author fastr
     *
